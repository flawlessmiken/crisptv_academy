...
class _EventCountdownState extends State<EventCountdown> {
  ...
  @override
  void initState() {
    _targetDateTime =parseDateTime33(widget.date);
  ...
  Widget build(BuildContext context) {
    Duration duration = _targetDateTime.difference(DateTime.now());
        ...
        children: [
          ...
          Row(
            ...
            children: [
              ...
              // const Expanded(child: SizedBox()),
              timeWidget("HOURS", hours.isNegative ? "0" : "$hours", maxWidth),
              // const Expanded(child: SizedBox()),
            ],
          ),
          const SizedBox(
          ...
          Row(
            ...
            children: [
              ...
              // ),
              // const Expanded(child: SizedBox()),
              timeWidget("MINUTES", minutes.isNegative ? "0" :"$minutes", maxWidth),
              const SizedBox(
                width: 10,
              ),
              // const Expanded(child: SizedBox()),
              ...
              // const Expanded(child: SizedBox()),
              timeWidget("SECONDS", seconds.isNegative ? "0" :"$seconds", maxWidth),
            ],
          ),
        ],
      );
